...
Complete the official AWS Skill Builder Solutions Architect Learning Plan. This is the foundational AWS training that precedes the SAA-C03 exam prep course. Being official AWS content, it provides authoritative knowledge of AWS services and architecture relevant to the Solutions Architect Associate certification.

---

## Resources

- [AWS Skill Builder - Solutions Architect Learning Plan](https://skillbuilder.aws/learning-plan/EB6SVX4CTK/aws-solutions-architect-learning-plan-includes-labs/SAJSTUCC44) - Official AWS training platform
...
- [ ] Solutions Architect learning path modules _(module/phase count pending reconfirmation against the SA plan's actual structure — see 2026-08-03 progress note)_
  - [ ] Phase 0
  - [ ] Phase 1
  - [ ] Phase 2
  - [ ] Phase 3
...
- [2026-08-03] Retargeted from the Developer Learning Plan to the Solutions Architect Learning Plan, following A♦️'s target certification pivot from Developer Associate (DVA-C02) to Solutions Architect Associate (SAA-C03). Phase 0 (previously complete) and Phase 1 (previously in progress; next step had been "Testing and Error Handling") reset to not-started — that progress was made under the Developer track's curriculum, which is content-distinct from the Solutions Architect track (architecture/networking/storage-focused rather than application code/testing-focused) and doesn't carry over. AWS Cloud Practitioner Essentials left as complete since it's track-agnostic foundational content.
