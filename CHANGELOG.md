...
- [10-hearts] — [Fall 26 > javaProgramming > Deliverables > Week 3] annotation updated (Project1)
...
- [10-hearts] — [Fall 26 > javaProgramming > Deliverables > Week 3] annotation updated (Mod1Asgn2, Wk3Check, Project1)
...
- [10-hearts] — [Fall 26 > advancedJavaScript > Deliverables > Week 1] marked in progress, annotation updated (Lab 1)
...
- [10-hearts] — [Fall 26 > javaProgramming > Deliverables > Week 1] annotation updated (Week 1 Checkpoint)
- [10-hearts] — [Fall 26 > javaProgramming > Deliverables > Week 2] marked in progress, annotation added (Labs (5, 6), Mod1Asign1, Week 2 Checkpoint)

### Completed

- [10-hearts] — [Fall 26 > javaProgramming > Deliverables > Week 1] marked complete
...
- [03-diamonds] — [Ch. 10: Files and Exceptions] closed
...
- [RESOURCES.md] — 9♣️ Claude Academy (formerly Anthropic Academy) added
- [09-clubs] — Claude Academy courses added to Resources and as a subtask series (parent + 5 children), migrated from Joker 1
...
- [RESOURCES.md] — 9♣️ _Cracking the Coding Interview_ by Gayle Laakmann McDowell added as a core interview prep resource
...
- [10-hearts] — [Learning Java, 6th Ed. < Ch. 1] annotation added (2026-08-20; Figure 1.1)
- [02-spades] — [Extra-curricular: Dr. Chuck C/OOP deep dive] annotation updated (2026-08-20; Ch. 5 reading)
...
- [03-diamonds] — [Ch. 9: Classes] annotation updated (2026-08-13)
...
- [05-diamonds] Added "Python fundamentals" AnkiWeb shared deck to Resources (pre-existing deck predating the goal-tracking system; title match inferred via browser history, unconfirmed against live deck content)
- [REFLECTIONS] — new entry added: Prerequisite structure: from pyramid to waterfall + Venn diagram, the first realized instance of the 2026-07-14 accelerant/prerequisite standing decision, surfaced via content overlap between 05-diamonds, 3♦️, and 6♣️
...
- [03-diamonds] — Part 1 subtasks restructured: reading (Ch. 1–11) and Try It Yourself exercises split into separate groups, reading-first, to reflect reading through the full part before circling back for exercises
...
- [CLAUDE] — Card File Conventions: new "Subtask Tree Retention" subsection documenting static vs. dynamic card subtask retention, and why PROGRESS.md may track dynamic cards by a signal other than a raw subtask fraction
...
- [03-spades-v2] — [Ch. 1 — The Tar Pit] closed
...
- [joker-1] — [Review and update social media & community accounts] marked in progress
- [joker-1] — [Review and update social media & community accounts > dev.to, Meetup] refactored (multiple labels simplified)
- [joker-1] — [Narrative voice review] updated annotation: (LinkedIn German profile, resumes)
- [09-clubs] — [Complete The LeetCode Beginner's Guide] updated annotation: (2026-07-03; inofficial progress reset, starting from beginning of guide)
...
- [10-hearts] — [uiUx > wk10] closed

### Changed

- [10-hearts] — [uiUx > wk11] marked in progress
- [10-hearts] — [uiUx > wk11] added annotation (Assignments)
...
- [10-hearts] — [agilePractices > wk12] closed (2026-04-25)
- [10-hearts] — [agilePractices > wk13] closed (2026-04-25)
...
- [10-hearts] — [Fulfill math elective requirement] added with discrete research steps: Franklin/MATC articulation agreement, CLEP options, CS elective confirmation, algebra/precalc/calculus progression
...
- [10-hearts] — refactored subtask structure: replaced week-by-week snapshot with full per-course breakdown for Spring 26; each course (c4d, agilePractices, db_prog, uiUx) now tracks individual deliverables with due dates and weekly checkoffs through end of semester
...
- [joker-2] — [Source cinematic wallpaper] closed (2026-03-23)

### Added

- [joker-2] — added goal: Own a Sport Luxury Vehicle (Mercedes-AMG or comparable)
- [joker-1] — [Declutter and liquidate unused possessions prior to relocation] added; marked in progress
...
- [joker-2] — transitioned: Not Started → In Progress (subtasks already underway)
- [joker-2] — [Acquire AMG branded apparel] marked in progress
- [04-diamonds] — [Debug C# Console Applications] promoted backlog → worklog
- [04-diamonds] — added Target Completion: 2026-03-31
- [04-diamonds] — prerequisite 2♦️ Markdown confirmed complete (2026-03-04)
- [05-hearts] — [Reach -20 lbs milestone] marked in progress

### Process

- [DECK_OVERVIEW] — refactored joker-2 from TBD → Own a Sport Luxury Vehicle
...
- [10-hearts] — [sp26wk7 > uiUx] promoted backlog → worklog
...
- [03-clubs] — [The Pragmatic Programmer > Chapter 7-8: While You Are Coding / Before the Project] promoted backlog → worklog
...
- [05-hearts] — [-10 lbs milestone] closed; confirmed reached earlier this year via Claude tracker data

### Changed

- [05-hearts] — refactored fasting goal from 1800 to 1900 hours
- [05-hearts] — [Integrate exercise and calorie tracking systems] promoted backlog → worklog
- [05-hearts] — [Identify and eliminate processed foods] promoted backlog → worklog
- [05-hearts] — [Establish 1900 hours fasting routine] promoted backlog → worklog
...
- [03-clubs] — [Lean Six Sigma White Belt Course] closed (2026-03-19)

### Changed

- [02-spades] — [Week 4: Memory] promoted backlog → worklog (lecture in progress, assignments not started)
...
- [03-clubs] — [Lean Six Sigma White Belt Course > Analyze] closed (2026-03-18)
- [03-clubs] — [Lean Six Sigma White Belt Course > Improve] closed (2026-03-18)
- [03-clubs] — [Lean Six Sigma White Belt Course > Control] closed (2026-03-18)
- [03-clubs] — [Lean Six Sigma White Belt Course > Certification Exam] closed (2026-03-18)

### Changed

- [10-hearts] — refactored [sp26wk7] and [sp26wk8] as nested subtasks under [Complete remaining required courses]
- [10-hearts] — [Complete remaining required courses] promoted backlog → worklog (ongoing)
- [10-hearts] — [Maintain satisfactory GPA] promoted backlog → worklog (ongoing)
...
- [10-hearts] — [sp26wk7 > db_prog] promoted backlog → worklog
- [02-spades] — [Week 1], [Week 2], and [Week 3] promoted backlog → worklog

### Process

- [10-hearts] — refactored all references to subtask 'dbProg' → 'db_prog' to remain consistent with local course directory
...
- [10-hearts] — [sp26wk7 > agilePractices] promoted backlog → worklog
...
- [10-hearts] — [sp26wk6 > agilePractices] promoted backlog → worklog
...
- [joker-1] — [German LinkedIn profile] promoted backlog → worklog
- [joker-1] — added [10-hearts] as prerequisite
...
- [10-hearts] — [sp26wk6 > c4d > Project 1] closed (2026-03-09)
- [10-hearts] — [sp26wk6 > c4d] closed (2026-03-09)
- [10-hearts] — [sp26wk7 > c4d > Week 7 Lab] closed (2026-03-09)

### Changed

- [10-hearts] — [sp26wk8] added to backlog
- [10-hearts] — [sp26wk7 > c4d > Project 2] deferred to sp26wk8
...
- [10-hearts] — [sp26wk6 > c4d > Week 6 Lab] closed (2026-03-08)
- [10-hearts] — [sp26wk6 > c4d > Week 6 Quiz] closed (2026-03-08)
- [05-hearts] — [Establish weekly meal prep routine] closed (2026-03-08)

### Changed

- [10-hearts] — [sp26wk7 > c4d] promoted backlog → worklog
- [03-clubs] — [Microsoft Learn GitHub Foundations Part 2 of 2 > Manage an InnerSource program by using GitHub] promoted backlog → worklog
...
- [10-hearts] — [sp26wk5 > Agile Practices] closed
- [10-hearts] — [sp26wk5] closed
- [03-clubs] — [Lean Six Sigma White Belt > Define] closed
- [03-clubs] — [The Pragmatic Programmer > Ch. 3–4] closed

### Changed

- [10-hearts] — added sp26wk7 checklist to worklog
- [03-clubs] — [Microsoft Learn GitHub Foundations Pt. 2 of 2] promoted backlog → worklog
...
- [02-diamonds] — added Time Invested retroactively (~7 hours across LinkedIn Learning, MS Learn GitHub Foundations Pt. 1, and reference docs)
...
- [10-hearts] — [sp26wk5 > dbProg > Project 1] closed
- [10-hearts] — [sp26wk6 > uiUx > Project 1] closed
- [02-diamonds] — [Microsoft Learn GitHub Foundations Pt. 1 of 2] closed
- [03-clubs] — [audiobook Ch. 1–2] closed
...
- [10-hearts] — [sp26wk5 > dbProg > Data Ethics] closed
- [10-hearts] — [sp26wk5 > c4d] closed
- [10-hearts] — [sp26wk5 > uiUx] closed
...
- [10-hearts] — [sp26wk4 > DBProg] closed
- [10-hearts] — [sp26wk4] closed

### Changed

- [10-hearts] — added sp26wk5 subtask checklist
- [02-diamonds] — refactored subtasks; [GitHub Foundations 4 of 8] closed; [GitHub Foundations 5 of 8] promoted backlog → worklog
...
- [10-hearts] — [sp26wk4 > Agile] closed

### Changed

- [02-diamonds] — refactored subtasks; [GitHub Foundations 3 of 8] closed
...
- [02-diamonds] — added metadata; 1 of 2 courses completed
- [10-hearts] — added Progress Notes and Time Invested estimate
- [05-hearts] — refactored Dietary Approach, subtasks, and Progress Notes; created recipe matrix
...
- [03-spades] — transitioned: Not Started → In Progress; Ch. 1 completed prior to tracking; Ch. 2 (read 1) closed (2026-02-15)
...
- [10-hearts] — added progress details (credits completed)
...
- Spades (13/13): Theory, Fundamentals & Mathematics
- Hearts (13/13): Personal Development
